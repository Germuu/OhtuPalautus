...
class TestKauppa(unittest.TestCase):
    ...
    def test_kaksois_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tupla_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_puuttuvan_kaksois_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_uusi_viite_uudelle_maksulle(self):
        ...
        kauppa.tilimaksu("pekka", "12345")
        pankki_mock.tilisiirto.assert_called_with("pekka", 3, "12345", "33333-44455", 5)
    ...
    def test_poisto_korista(self):
        ...
        kauppa.aloita_asiointi()
        kauppa.lisaa_koriin(1)
        varasto_mock.ota_varastosta.assert_called_with(Tuote(1, "maito", 5))
